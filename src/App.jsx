...
function PublicSite() {
  ...
  return <div className="site-shell" id="top">
    ...
    <main>
      ...
      <section className="location" id="location"><div className="location__visual" data-reveal><div className="map-lines" aria-hidden="true"><i /><i /><i /><i /></div><span className="location__pin"><Icon name="pin" size={27} /></span><span className="location__tag">You’ve found us</span></div><div className="location__content" data-reveal><div className="section-label section-label--light"><span>04</span> The way here</div><h2>Far enough<br />to feel <em>away.</em></h2><p>San Felipe sits between the West Philippine Sea and the Zambales mountains, around four hours from Metro Manila by road.</p><dl><div><dt>From Manila</dt><dd>Approx. 4 hours</dd></div><div><dt>From Clark</dt><dd>Approx. 2.5 hours</dd></div><div><dt>Transfers</dt><dd>Available on request</dd></div></dl><a className="text-link text-link--light" href="https://www.google.com/maps/search/?api=1&query=San+Felipe+Zambales+Philippines" target="_blank" rel="noreferrer">Open in Google Maps <Icon name="arrow" size={17} /></a></div></section>
