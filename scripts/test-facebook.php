...
try {
    ...
    checkFacebook(str_contains($initialReply, 'Please send only:') && str_contains($initialReply, 'Check-in time: Needed') && str_contains($initialReply, 'Check-out time: Needed') && str_contains($initialReply, 'Total pax: NOT PROVIDED YET') && str_contains($initialReply, 'Name: Needed'), 'Booking shows received and missing details together');
    ...
    checkFacebook(str_contains($summaryReply, 'PENDING') && str_contains($summaryReply, 'Check-in 2:00 PM · Check-out 11:00 AM') && str_contains($summaryReply, 'Suggested room:'), 'One customer message produces a clearly labelled suggested-room summary with times');
